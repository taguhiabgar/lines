...
- (void)setupScoreLabel {
    ...
    [self.scoreLabel setBackgroundColor:[[[[ThemeManager sharedThemeManager] currentTheme] buttonsBackgroundColor] colorWithAlphaComponent:gameResultViewControllerScoreLabelBackgroundColorAlphaComponent]];
